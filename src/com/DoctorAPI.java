...
public class DoctorAPI extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
		// TODO Auto-generated method stub
		String output = DoctorObj.addDoctor(request.getParameter("doctorid"), request.getParameter("doctorid"),
				request.getParameter("doctorName"), request.getParameter("email"), request.getParameter("specialist"),
	...
	protected void doPut(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String output = DoctorObj.updateDoctor(paras.get("doctorid").toString(),
